...
const fastFoodOrderSchema = new mongoose.Schema({
  user: {
  ...
  combos: [
    {
      combo: {
        type: mongoose.Schema.Types.ObjectId,
        ref: "comboMeal", // Assuming you have a Dish model
        required: true,
      },
      title: {
        type: String,
  ...
  status: {
    ...
    default: ORDER_STATUS_MESSAGE.PENDING,
  },
  isJain: {
    type: Boolean,
    default: false,
...
const FastFoodOrderModel = mongoose.model("FastFoodOrder", fastFoodOrderSchema);

module.exports = FastFoodOrderModel;
